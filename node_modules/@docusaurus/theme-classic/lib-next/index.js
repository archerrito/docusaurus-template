  ...
  return {
    ...
    configureWebpack() {
      const prismLanguages = additionalLanguages
        .map((lang) => `prism-${lang}`)
        .join('|'); // See https://github.com/facebook/docusaurus/pull/3382

      const useDocsWarningFilter = (warning) =>
        ...
        postCssOptions.plugins.push(
          postcss.plugin('RtlCssPlugin', () => {
            ...
            return function (root) {
              const file = root?.source.input.file; // Skip Infima as we are using the its RTL version.
